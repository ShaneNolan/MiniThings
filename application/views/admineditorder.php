        ...
        <tbody>
          ...
          foreach($order as $ord){
            ...
            echo '<tr><td>' . $ord->productCode . '</td><td>' .
                  $ord->productName . '</td><td><input type="text" name="delivered" value="' .$ord->requiredDate .
                  '"></input></td><td><input type="text" name="comments" value="' .
                  (empty($ord->comments) ? "..." : $ord->comments) . '"></input></td><td><input
                  style="width:70%" type="number" name="quantity" value="' . $ord->quantityOrdered . '"></input>
